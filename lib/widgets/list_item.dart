  ...
  Widget build(BuildContext inContext) {
    return Container(
      ...
      child: InkWell(
        onTap: () async {
          /// *** ////
          // Provider.of<NoteProvider>(inContext, listen: false).entityBeingEdited =
          // await DatabaseHelper.db.get(id);
          Navigator.pushNamed(inContext, NoteViewScreen.route, arguments: id);
        },
        child: Container(
          width: double.infinity,
